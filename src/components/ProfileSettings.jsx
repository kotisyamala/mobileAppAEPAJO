...
import { CreditCard, Download, Sun, Moon, QrCode, ToggleLeft, ToggleRight, X, ShieldCheck } from "lucide-react";
  ...
  return (
    <div className="fade-in" style={{ padding: "24px 20px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "28px" }}>
        ...
        <div>
          <h2 style={{ fontSize: "1.2rem", margin: 0, color: "var(--text-primary)" }}>{activeProfile.firstName} {activeProfile.lastName}</h2>
      ...
      <div style={{ backgroundColor: "var(--bg-secondary)", borderRadius: "16px", border: "1px solid var(--border-color-light)", padding: "18px", marginBottom: "24px" }}>
        <h3 style={{ fontSize: "0.8rem", fontWeight: "700", textTransform: "uppercase", letterSpacing: "0.05em", color: "var(--text-secondary)", marginBottom: "14px" }}>
          Account Details
        </h3>
        <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <span style={{ fontSize: "0.78rem", color: "var(--text-secondary)" }}>Email</span>
            <span style={{ fontSize: "0.78rem", fontWeight: "600", color: "var(--text-primary)" }}>{activeProfile.email}</span>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <span style={{ fontSize: "0.78rem", color: "var(--text-secondary)" }}>Phone</span>
            <span style={{ fontSize: "0.78rem", fontWeight: "600", color: "var(--text-primary)" }}>{activeProfile.phone}</span>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <span style={{ fontSize: "0.78rem", color: "var(--text-secondary)" }}>CRM ID</span>
            <span style={{ fontSize: "0.72rem", fontWeight: "600", color: "var(--accent-color)", fontFamily: "var(--font-mono)" }}>{activeProfile.crmId}</span>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <span style={{ fontSize: "0.78rem", color: "var(--text-secondary)" }}>Active Plan</span>
            <span style={{ fontSize: "0.78rem", fontWeight: "600", color: "var(--success-color)" }}>{activePlan?.name || "N/A"}</span>
          </div>
        </div>
      </div>
